...
final class CameraConfigurationManager {
    ...
    /**
     * 创建一个新的实例 CameraConfigurationManager.
     *
     * @param context
     * @param isPortrait 是否是竖屏模式
     */
    public CameraConfigurationManager(Context context, boolean isPortrait) {
        this.context = context;
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        Log.d(TAG, "Camera resolution: " + cameraResolution + ", Screen resolution: " + screenResolution);
    }
